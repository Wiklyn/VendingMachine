    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Coca-Cola (12 oz can)", 1.50m, 10 },
                    { 2, "Doritos (1.75 oz bag)", 1.75m, 7 },
                    { 3, "Snickers Bar", 1.25m, 3 }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Name", "Price" },
                values: new object[] { 4, "Bottled Water (16.9 oz)", 1.00m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5, "M&M’s (1.69 oz pack)", 1.50m, 5 },
                    { 6, "Red Bull (8.4 oz can)", 2.50m, 2 }
                });
